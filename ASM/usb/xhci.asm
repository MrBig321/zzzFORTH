...
%define	XHCI_HEAP_INIT		0x600000		; from FORTH-Memory-Map(FMM) in forth/common.asm
%define	XHCI_HEAP_SIZE		0x400000			; from FORTH-Memory-Map(FMM) in forth/common.asm
...
xhci_process:
	...
	; BaseReg bits 2:0 (2:1 Type; 0 Memmapped(0) or PortI/O(1))
	;					Type: 0 BaseReg is 32bit wide; 1 reserved; 2 64bit wide
			; get base
			push eax
			mov edx, PCI_BAR0
			call pci_config_read_dword
