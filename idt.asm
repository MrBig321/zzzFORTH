...
.Audio		cmp BYTE [pci_hdaudio_det], 1
			jnz	.Next
			xor ebx, ebx
			mov bl, [pci_hdaudio_irq_num]
			add ebx, 32			; IRQs from 0-15 are remapped to 32-47 in PIC
...
idt_isr_hdaudio:
			...
			mov al, [pci_hdaudio_irq_num]					; EOI
			call pic_interrupt_done
			popad
			sti
			iret
...
;idt_isrHD14txt db "HD14 IRQ", 0x0A, 0
;idt_isrHD15txt db "HD15 IRQ", 0x0A, 0
