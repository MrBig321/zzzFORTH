...
d_zero_equals_	dd _d_zero_equals
				db "d0=", 0, 0
d_l_shift_		dd _d_l_shift
				db "dlshift", 0, 0
d_r_shift_		dd _d_r_shift
				db "drshift", 0, 0
...
au_bar_	dd _au_bar
		db "aubar", 0, 0
au_set_isr_	dd _au_set_isr
			db "ausetisr", 0, 0

delay_	dd _delay
		db "delay", 0, 0

clr_ticks_	dd _clr_ticks
		db "clrticks", 0, 0

lusb_	dd _load_usb_fth
		db "lusb", 0, 0
...
word_arr	dd abort_, abort_quote_, abs_, accept_, again_, ahead_, align_, aligned_, allot_, and_, at_x_y_, get_x_y_
			...
			dd i_, if_, immediate_, inb_, insw_, inw_, ind_, interpret_, invert_
			...
			dd one_plus_, one_minus_, or_, outb_, outsw_, outw_, outd_, over_, page_, page_n
			...
			dd parse_, pause_, pick_, plus_, plus_loop_, plus_store_, postpone_, pow_
			...
			dd then_, throw_, tick_, time_, to_body_, to_number_, to_r_, true_, tuck_, type_, two_plus_, two_minus_ 
			...
			dd variable_, view_err_, w_comma_, w_fetch_, w_plus_, w_plus_store_, w_store_
			...
			dd d_zero_less_, d_zero_equals_, d_l_shift_, d_r_shift_, d_two_star_, d_two_slash_, d_less_than_, d_u_less_, d_equals_ 
			dd d_abs_, d_max_, d_min_, d_negate_, star_slash_, star_slash_mod_, m_star_slash_, m_star_, u_m_star_ 
			dd u_m_slash_mod_, f_m_slash_mod_, s_m_slash_rem_, s_to_d_, d_to_s_, m_plus_
...
%ifdef MULTITASKING_DEF
			...
			; Multitasking
			dd activate_, gettbuff_, kill_, resume_, suspend_, task_, tasks_, task_clear_counter_, terminate_
%endif
